...
def build_model(input_X, input_Y, is_training=True, num_block=4, learning_rate=0.0002):
  ...
  if is_training:
    ...
    real_DY = discriminator(input_Y, "discriminatorD", reuse=False)
    fake_DY = discriminator(Y_from_X, "discriminatorD", reuse=True)
    ...
    losses = {'loss_G': loss_G, 'loss_D': loss_D, 'loss': loss_G}
